...
from note_service.domain.code_sequence import _advisory_lock_key, next_code
...
async def test_subsequent_codes_increment():
    ...
    assert (a, b, c) == ("NOTE-2026-00001", "NOTE-2026-00002", "NOTE-2026-00003")
...
async def test_counter_isolated_per_year():
    ...
    assert a == "NOTE-2026-00001"
    assert b == "NOTE-2027-00001"
