...
| `auth.signup`                     | info     | auth-service POST /auth/email/verify | IDX-A3 — new identity + personal workspace created; written to the new tenant. Payload: identity_id, tenant_id |
